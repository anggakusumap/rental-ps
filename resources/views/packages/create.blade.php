...
@section('content')
    <div class="max-w-3xl mx-auto">
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-800 mt-4">Create New Package</h1>
            <p class="text-gray-600 mt-1">Create a time-based pricing package</p>
        </div>
            ...
            <form method="POST" action="{{ route('packages.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <input
                        ...
                        value="{{ old('name') }}"
                        required
                        placeholder="e.g., 2 Hour Package, Half Day Package"
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-500 text-sm mt-2">
                        <span class="font-semibold">Total:</span> <span id="total-duration">0 minutes</span>
                    </p>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-500 text-sm mt-1">
                        <span class="font-semibold">Effective rate:</span> <span id="effective-rate">Rp 0/hour</span>
                    </p>
                </div>
